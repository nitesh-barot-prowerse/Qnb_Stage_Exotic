Feature: Verify Minimum and Maximum age criteria of various breed
  ...
  Scenario: User does not allowed to go further if age of any reptile species is less than 12
    ...
    And User enters pet date of birth less than 8 week from current date for reptile product
    Then User will come across error message and not allowed to move further on the system
  ...
  Scenario: User does not allowed to go further if age of any bird species is more than 10
    When User enters name of pet and upload image of same
    And User selects product and species from respected  dropdown for bird product
    And User enters pet date of birth more than 10 years from current date for bird product
    Then User will come across error message and not allowed to move further on the system

  Scenario: User does not allowed to go further if age of any Mammals species  is more than 5
    When User enters name of pet and upload image of same
    And User selects product and species from respected  dropdown for mammals product
    And User enters pet date of birth more than 5 years from current date for mammals product
    Then User will come across error message and not allowed to move further on the system

  Scenario: User does not allowed to go further if age of any reptile species is more than 10
    When User enters name of pet and upload image of same
    And User selects product and species from respected  dropdown for reptile product
    And User enters pet date of birth more than 10 years from current date for reptile product
    Then User will come across error message and not allowed to move further on the system

  Scenario: User does not allowed to go further if age of any tortoise species  is more than 50
    When User enters name of pet and upload image of same
    And User selects product and species from respected  dropdown for tortoise product
    And User enters pet date of birth more than 50 years from current date for tortoise product
    Then User will come across error message and not allowed to move further on the system